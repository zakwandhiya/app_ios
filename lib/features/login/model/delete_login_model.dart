class DeleteLoginResponseModel {
  String imgJson;
  String id;
  String createdBy;
  String sN;
  ...
  factory DeleteLoginResponseModel.fromJson(Map<String, dynamic> data) {
    DeleteLoginResponseModel dataModel = DeleteLoginResponseModel(
