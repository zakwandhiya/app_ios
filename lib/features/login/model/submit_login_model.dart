class SubmitLoginResponseModel {
  String imgJson;
  String id;
  String createdBy;
  String sN;
  ...
  factory SubmitLoginResponseModel.fromJson(Map<String, dynamic> data) {
    SubmitLoginResponseModel dataModel = SubmitLoginResponseModel(
