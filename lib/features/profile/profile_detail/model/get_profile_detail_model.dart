class GetProfileDetailResponseModel {
  ...
  factory GetProfileDetailResponseModel.fromJson(Map<String, dynamic> data) {
    GetProfileDetailResponseModel dataModel = GetProfileDetailResponseModel(
