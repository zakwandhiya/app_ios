class SubmitProfileDetailResponseModel {
  String imgJson;
  String id;
  String createdBy;
  String sN;
  ...
  SubmitProfileDetailResponseModel({
  ...
  factory SubmitProfileDetailResponseModel.fromJson(Map<String, dynamic> data) {
    SubmitProfileDetailResponseModel dataModel = SubmitProfileDetailResponseModel(
