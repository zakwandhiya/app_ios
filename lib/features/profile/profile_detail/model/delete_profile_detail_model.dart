class DeleteProfileDetailResponseModel {
  String imgJson;
  String id;
  String createdBy;
  String sN;
  ...
  DeleteProfileDetailResponseModel({
  ...
  factory DeleteProfileDetailResponseModel.fromJson(Map<String, dynamic> data) {
    DeleteProfileDetailResponseModel dataModel = DeleteProfileDetailResponseModel(
