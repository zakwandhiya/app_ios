...
class MataKuliahAddWisudaPage extends StatefulWidget {
  final bool add;

  const MataKuliahAddWisudaPage({
    super.key,
    this.add = true,
  });

  @override
  _MataKuliahAddWisudaPageState createState() => _MataKuliahAddWisudaPageState();
}

class _MataKuliahAddWisudaPageState extends State<MataKuliahAddWisudaPage> {
